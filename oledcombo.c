...
/* Combination OLED display module that renders bongocat on primary
   and modifier status on the secondary.
...
// Render modifier status display
...
void render_primary(void) { animate_cat(); }
void render_secondary(void) { render_mod_status(); }
