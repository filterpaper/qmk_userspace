...
#define RAISE \
	...
	_______, _______, _______, _______, Z_PASTE, _______, _______, G(KC_V), G(KC_C), G(KC_X), _______, _______
#define ADJUST \
...
// Last row
#define CORNEQWERTY                                   LT(5,KC_VOLD), LT(2,KC_VOLU), RSFT_T(KC_ENT), RSFT_T(KC_SPC), LT(3,KC_SPC), RGUI_T(KC_BSPC)
