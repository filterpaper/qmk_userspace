...
#define _NUMB \
	...
	_______, KC_CAPS, KC_7,    KC_8,    KC_9,    KC_0,        KC_INS,  _______, _______, _______, _______, _______, \
 ...
 */
#define _SYMB \
	_______, _______, KC_LBRC, KC_LCBR, KC_RCBR, _______,     KC_VOLU, KC_LPRN, KC_RPRN, KC_RBRC, KC_TILD, _______, \
	_______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,     KC_VOLD, KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,  _______, \
	_______, _______, KC_CIRC, KC_AMPR, KC_ASTR, _______,     KC_MUTE, KC_UNDS, KC_PLUS, KC_PIPE, _______, _______, \
...
#define _FUNC \
	...
	_______, Z_SLEEP, KC_F11,  KC_F12,  Z_PASTE, _______,     _______, KC_BTN2, KC_BTN1, _______, Z_SHUT,  _______, \
	                           RESET,   _______, _______,     _______, _______, _______
/* ,-----------------------------------------.                ,-----------------------------------------.
 * |      |  F1  |  F2  |  F3  |  F4  |  F5  |                |      | WH_U | WH_D |      |_COLE |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      |  F6  |  F7  |  F8  |  F9  | F10  |                | MS_L | MS_D | MS_U | MS_R |      |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      |SLEEP | F11  | F12  |PASTE |      |                |      | BTN2 | BTN1 |      | SHUT |      |
 * `------+------+------+------+------+------+------.  ,------+------+------+------+------+------+------|
 *                             |RESET |      |      |  |      |      |      |
 *                             `--------------------'  `--------------------'
 */
...
// Bottom row keys
#define O_BASE 	KC_DEL, KC_VOLD, KC_VOLU, RSA_T(KC_TAB), LT(SYM,KC_NO), RSG_T(KC_ENT), \
				RSFT_T(KC_SPC), LT(NUM,KC_NO), RAG_T(KC_LEFT), KC_DOWN, KC_UP, KC_RGHT
...
#define O_FUNC _______, _______, _______, RESET,   _______, _______, _______, _______, _______, _______, _______, _______
