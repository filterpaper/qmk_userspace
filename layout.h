...
#define MARK_LAYER3 \
	...
	#define G_QWER \
		...
		Z_TH,    KC_X,    KC_C,    KC_V,    KC_B,       KC_N,    M_TH,    COMM_TH, DOT_TH,  KC_SLSH, \
	...
	#define G_NUMB \
		_______, KC_1,    KC_2,    KC_3,    _______,    _______, KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, \
		_______, KC_4,    KC_5,    KC_6,    _______,    _______, KC_LCBR, KC_RCBR, _______, KC_VOLU, \
		_______, KC_7,    KC_8,    KC_9,    KC_0,       _______, _______, _______, _______, KC_VOLU, \
			              _______, _______, _______,    _______, _______, _______
	#define G_NAVI \
		...
		KC_CAPS, _______, _______, _______, _______,    KC_PGDN, KC_UNDS, KC_PLUS, KC_PIPE, _______, \
			              _______, _______, _______,    _______, _______, _______
	#define G_FUNC \
		KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,      KC_HOME, KC_WH_U, KC_WH_D, _______, _______, \
		KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,     KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_INS,  \
		RESET,   _______, _______, Z_PASTE, _______,    KC_END,  KC_BTN2, KC_BTN1, _______, TG(COLE),\
			              _______, _______, _______,    _______, _______, _______
