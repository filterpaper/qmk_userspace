...
#define _NAVI \
	...
	KC_GRV,  _______, KC_CIRC, KC_AMPR, KC_ASTR, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_INS,  KC_VOLU, \
	KC_CAPS, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_DEL,  KC_VOLD
#define _FUNC \
	RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______, KC_WH_U, KC_WH_D, _______, _______, TG(COLE),\
...
#define _SYML \
	KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______, _______, _______, _______, _______, _______, \
	KC_GRV,  _______, KC_CIRC, KC_AMPR, KC_ASTR, _______, _______, KC_RGUI, KC_RCTL, KC_RALT, KC_RSFT, _______, \
