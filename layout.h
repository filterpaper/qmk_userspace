...
#define _NUMB \
	...
	_______, KC_0,    KC_4,    KC_5,    KC_6,    KC_VOLD,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT, _______, \
	_______, KC_CAPS, KC_7,    KC_8,    KC_9,    KC_MUTE,     _______, _______, _______, _______, _______, _______, \
	                           _______, MO(FNC), KC_ESC,      _______, _______, _______
/* ,-----------------------------------------.                ,-----------------------------------------.
 * |      |      |  1   |  2   |  3   | VOLU |                | HOME | PGDN | PGUP | END  |  "   |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      |  0   |  4   |  5   |  6   | VOLD |                | LEFT | DOWN |  UP  | RGHT |  '   |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      | CAPS |  7   |  8   |  9   | MUTE |                |      |      |      |      |      |      |
 * `------+------+------+------+------+------+------.  ,------+------+------+------+------+------+------'
 *                             |      |_FUNC | ESC  |  |      |      |      |
