...
#define _NUMB \
	...
	_______, KC_ESC,  KC_4,    KC_5,    KC_6,    KC_VOLD,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT, _______, \
	_______, KC_CAPS, KC_7,    KC_8,    KC_9,    KC_0,        _______, _______, _______, _______, _______, _______, \
	                           _______, MO(FNC), KC_ENT,      _______, _______, _______
/* ,-----------------------------------------.                ,-----------------------------------------.
 * |      |      |  1   |  2   |  3   | VOLU |                | HOME | PGDN | PGUP | END  |  "   |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      | ESC  |  4   |  5   |  6   | VOLD |                | LEFT | DOWN |  UP  | RGHT |  '   |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      | CAPS |  7   |  8   |  9   |  0   |                |      |      |      |      |      |      |
 * `------+------+------+------+------+------+------.  ,------+------+------+------+------+------+------'
 *                             |      |_FUNC | ENT  |  |      |      |      |
...
#define _FUNC \
	...
	_______, Z_SLEEP, _______, _______, KC_F11,  KC_F12,      _______, KC_BTN2, KC_BTN1, _______, KC_DEL,  _______, \
...
#define _FUNC \
	...
	_______, Z_SLEEP, _______, _______, KC_F11,  KC_F12,      _______, _______, _______, _______, KC_DEL,  _______, \
	                           _______, _______, RESET,       Z_SHUT,  _______, _______
#endif
...
// Corne to Ferris layout conversion
#define C_FER(k) SPLIT_3x6_3_TO_3x5_2(k)
