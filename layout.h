...
#define _NAVI \
	...
	KC_CAPS, _______, _______, _______, _______, _______,     KC_PGDN, KC_UNDS, KC_PLUS, KC_PIPE, _______, _______, \
	                           _______, _______, _______,     KC_VOLD, MO(FNC), KC_VOLU
#define _FUNC \
...
#define HRM36_SACG( \
	...
	k01, k02, k03, k04, k05, k06, k07, k08, k09, k10, \
	SFT_T(k11), ALT_T(k12), CTL_T(k13), GUI_T(k14), k15, \
	k16, GUI_T(k17), CTL_T(k18), ALT_T(k19), SFT_T(k20), \
	k21, k22, k23, k24, k25, k26, k27, k28, k29, k30, \
	k31, k32, k33, k34, k35, k36
...
#define W_NUMB \
	...
	_______, KC_4,    KC_5,    KC_6,    _______,     _______, KC_LCBR, KC_RCBR, _______, KC_QUOT, \
	_______, KC_7,    KC_8,    KC_9,    KC_0,        _______, KC_LBRC, KC_RBRC, _______, _______, \
	                 _______, MO(FNC), _______,      _______, _______, _______
#define W_NAVI \
...
#define W_FUNC \
	...
	Z_SLEEP, _______, _______, Z_PASTE, _______,     KC_END,  KC_BTN2, KC_BTN1, KC_DEL,  _______, \
	                    RESET, _______, _______,     _______, _______, TG(CMK)
