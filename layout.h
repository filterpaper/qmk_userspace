 ...
 */
#define _FUNC \
	_______, RESET,   KC_F1,   KC_F2,   KC_F3,   KC_F10,      KC_INS,  KC_WH_U, KC_WH_D, _______, TG(CMK), _______, \
	_______, _______, KC_F4,   KC_F5,   KC_F6,   KC_F11,      KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______, \
	_______, Z_SLEEP, KC_F7,   KC_F8,   KC_F9,   KC_F12,      KC_DEL,  KC_BTN2, KC_BTN1, _______, _______, _______, \
	                           _______, _______, _______,     _______,	 _______, _______
/* ,-----------------------------------------.                ,-----------------------------------------.
 * |      |RESET |  F1  |  F2  |  F3  | F10  |                | INS  | WH_U | WH_D |      |_COLE |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      |      |  F4  |  F5  |  F6  | F11  |                | MS_L | MS_D | MS_U | MS_R |      |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      |SLEEP |  F7  |  F8  |  F9  | F12  |                | DEL  | BTN2 | BTN1 |      |      |      |
 * `------+------+------+------+------+------+------.  ,------+------+------+------+------+------+------'
 *                             |      |      |      |  |      |      |      |
 *                             `--------------------'  `--------------------'
 */
