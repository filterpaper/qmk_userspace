...
#define IS_MOD_TAP_SHIFT(k) (IS_QK_MOD_TAP(k) && (MOD_TAP_GET_MOD_BITS(k) & MOD_MASK_SHIFT))
#define IS_MOD_TAP_CAG(k)   (IS_QK_MOD_TAP(k) && (MOD_TAP_GET_MOD_BITS(k) & MOD_MASK_CAG))
