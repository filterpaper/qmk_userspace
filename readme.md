...
```
## NanoBoot
Clone [sigprof's nanoBoot](https://github.com/sigprof/nanoBoot), and run `make` to build the boot loader. Replace current boot loader with nanoBoot using the following command and fuses:
```c
