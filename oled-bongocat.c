...
static void render_cat_idle(void) {
	...
	static uint16_t const *idle_diff[IDLE_FRAMES] = {
		idle_diff_0, idle_diff_0, idle_diff_1, idle_diff_2, idle_diff_3
	};
#endif
#ifndef RIGHTCAT
	...
	static uint16_t const *left_idle_diff[IDLE_FRAMES] = {
		left_idle_diff_0, left_idle_diff_0, left_idle_diff_1, left_idle_diff_2, left_idle_diff_3
	};
#endif
...
static void render_cat_tap(void) {
	...
	static uint16_t const *left_tap_diff[TAP_FRAMES] = {
		left_tap_diff_0, left_tap_diff_1
	};
#endif
